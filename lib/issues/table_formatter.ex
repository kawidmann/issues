defmodule Issues.TableFormatter do
  ...
  @doc """
  Given a list containing rows of data, a list containing the header slectors, and a format string, write the extracted data under control of the format string.
  """
